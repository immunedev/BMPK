...
const steps = [
    "Bezpłatna analiza umowy kredytowej oraz sytuacji klienta.",
...
const requiredDocuments = [
    "Umowa kredytu frankowego (oryginał lub kopia).",
        ...
        <div className="max-w-[80%] mx-auto">
            <header className="text-center mb-16">
                ...
                <p className="text-rose-400 text-lg font-medium">
                    Skutecznie pomagamy w anulowaniu kredytów CHF. Poznaj naszą ofertę i odzyskaj spokój.
                </p>
            ...
            <section className="bg-white rounded-3xl shadow-2xl border border-rose-100 mb-12 p-8">
                ...
                <p className="text-slate-700 text-lg font-medium mb-2">
                    Oferujemy kompleksową obsługę prawną w zakresie unieważnienia kredytów frankowych. Nasz zespół prowadzi sprawę od bezpłatnej analizy po uzyskanie prawomocnego wyroku i rozliczenie z bankiem. Działamy skutecznie, transparentnie i z pełnym zaangażowaniem.
                </p>
            </section>
